...
ch$raise::usage = "List of rising vectors in even semisimple part of g0";
ch$lower::usage = "List of lowering vectors in even semisimple part of g0";
ch$alg::usage = "The algebra those cohomoligies are calculated";
ch$d::usage = "module DLeft[ch$alg]";
ch$g0::usage = "an algebra acting on ch$alg";
ch$gen::usage = "the list of generators of ch$g0";
ch$basis::usage =
    "ch$basis[r,deg] should return the list of all r-forms of degree deg";
ch$Split::usage = "the function used to split basis to homogenous parts"
chSetAlg::usage =
...
ch$res::usage = "The results of chCalc are stored in ch$res[s,r]={ker,im}"
ch$tab::usage = "The table of dimensions are stored in ch$tab[s]"
chRes::usage = "chRes[] returns the last calculated cohomology.
...
ch$M::usage="The module of differential forms"
ch$Wt::usage="The name of the weight function relative to Cartan subalgebra of g0. Default is Weight."
ch$ex::usage="The g0-module of exact forms"
...
chInMod::usage="chInMod[m,V] checks if vector V is inside m (modulo exact forms)"

chInSol::usage="chInSol[m,V] solves condition V in m (modulo exact forms)"

chExSol::usage="chInSol[V] solves condition V==0 (modulo exact forms)"

chRate::usage=
 "chRate[v] returns the rating table for coefficients in general sum (for selecting
 in mixed cohomologies)"

chSplit::usage = "The user-defined function used to split basis to homogenous parts"
chBasis::usage =
    "The user-defined function chBasis[r,s] should return the list of all r-forms of degree s"

chPrint::usage = "chPrint[s,r] prints the results of calculations of (<=r)-cohomologies of grade s."

ch$Print::usage = "Controls the amount of informatiom printed by chPrint. Default is 0.
 Set to -1 to disable all printing."


ch$Out::usage = "The value of ch$Out is a function that is applied to cohomologies when printing.
 The default value is Identity."

chNext::usage = "chNext[] shows the next calculated cohomology. If the cohomology is pure, the
...
dlist[d_, k_] := Select[DegreeBasis[k, Basis[ch$d], Wedge], Grade[#] == d &]
